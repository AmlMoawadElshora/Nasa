...
def predict_with_model(model_name, inputs):
    ...
    model_paths = {
        "Kepler Model": "models and stream lit/3 models for every mission/best_model_kepler.pkl",
        "104-Input Kepler": "models and stream lit/model kepler df new with 104 inputs/best_model.pkl",
        "TESS Model": "models and stream lit/3 models for every mission/best_model_tess.pkl",
        "K2 Model": "models and stream lit/3 models for every mission/best_model_k2.pkl"
    }
